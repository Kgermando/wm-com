...
class CourbeVenteGainYearSucc extends StatefulWidget {
  const CourbeVenteGainYearSucc(
  ...
  @override
  State<CourbeVenteGainYearSucc> createState() => _CourbeVenteGainYearSuccState();
}

class _CourbeVenteGainYearSuccState extends State<CourbeVenteGainYearSucc> {
