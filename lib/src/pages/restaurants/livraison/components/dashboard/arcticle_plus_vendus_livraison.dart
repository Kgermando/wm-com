...
class ArticlePlusVendusLivraison extends StatefulWidget {
  ...
  @override
  State<ArticlePlusVendusLivraison> createState() =>
      _ArticlePlusVendusLivraisonState();
}

class _ArticlePlusVendusLivraisonState
    extends State<ArticlePlusVendusLivraison> {
        ...
        child: SfCartesianChart(
          ...
          series: <ChartSeries>[
            ...
            BarSeries<VenteChartRestaurantModel, String>(
                ...
                xValueMapper: (VenteChartRestaurantModel gdp, _) =>
                    gdp.identifiant,
