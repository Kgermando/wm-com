...
import 'package:wm_com/src/widgets/button_widget.dart';
import 'package:intl/intl.dart';
import 'package:pluto_grid/pluto_grid.dart';

class ViewStatSuccursale extends StatefulWidget {
  const ViewStatSuccursale({Key? key, required this.succursaleModel})
      : super(key: key);
  final SuccursaleModel succursaleModel;

  @override
  State<ViewStatSuccursale> createState() => _ViewStatSuccursaleState();
}

class _ViewStatSuccursaleState extends State<ViewStatSuccursale> {
