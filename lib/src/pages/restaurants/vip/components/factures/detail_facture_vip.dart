...
import 'package:wm_com/src/pages/restaurants/vip/components/factures/cart/table_facture_vip_cart.dart';
import 'package:wm_com/src/pages/restaurants/vip/components/factures/pdf_a6/facture_vip_a6_pdf.dart';
...
class DetailFactureVip extends StatefulWidget {
  const DetailFactureVip({super.key, required this.factureRestaurantModel});
  final FactureRestaurantModel factureRestaurantModel;

  @override
  State<DetailFactureVip> createState() => _DetailFactureVipState();
}

class _DetailFactureVipState extends State<DetailFactureVip> {
  final FactureVipController controller = Get.find();
  final MonnaieStorage monnaieStorage = Get.put(MonnaieStorage());
  final FactureVipPDFA6 factureRestaurantPDFA6 = Get.put(FactureVipPDFA6());
