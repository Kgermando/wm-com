...
import 'package:wm_com/src/pages/restaurants/vip/components/consommation/pro_format_vip.dart';
          ...
          return StatefulBuilder(builder: (context, StateSetter setState) {
            return AlertDialog(
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                    final form = vipController.factureFormKey.currentState!;
                    if (form.validate()) {
          ...
          return StatefulBuilder(builder: (context, StateSetter setState) {
            return AlertDialog(
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                    final form = vipController.creanceFormKey.currentState!;
                    if (form.validate()) {
