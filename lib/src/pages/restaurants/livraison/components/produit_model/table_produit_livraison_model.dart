...
class TableProduitLivraisonModel extends StatefulWidget {
  ...
  @override
  State<TableProduitLivraisonModel> createState() =>
      _TableProduitLivraisonModelState();
}

class _TableProduitLivraisonModelState
    extends State<TableProduitLivraisonModel> {
  ...
  Future<List<PlutoRow>> agentsRow() async {
    ...
    List.generate(widget.produitModelList.length, (index) {
      ...
      return rows.add(PlutoRow(cells: {
        ...
        'price': PlutoCell(
            value:
                "${NumberFormat.decimalPattern('fr').format(double.parse(item.price))} ${monnaieStorage.monney}"),
        'created':
