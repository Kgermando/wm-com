...
class CourbeVenteGainYearLivraison extends StatefulWidget {
  ...
  @override
  State<CourbeVenteGainYearLivraison> createState() =>
      _CourbeVenteGainYearLivraisonState();
}

class _CourbeVenteGainYearLivraisonState
    extends State<CourbeVenteGainYearLivraison> {
