...
class CourbeVenteGainMounthTerrasse extends StatefulWidget {
  ...
  @override
  State<CourbeVenteGainMounthTerrasse> createState() =>
      _CourbeVenteGainMounthTerrasseState();
}

class _CourbeVenteGainMounthTerrasseState
    extends State<CourbeVenteGainMounthTerrasse> {
