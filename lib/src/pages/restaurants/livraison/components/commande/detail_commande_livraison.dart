...
import 'package:wm_com/src/pages/restaurants/livraison/components/commande/bon_commande_livraison.dart';
...
class DetailCommandeLivraison extends StatefulWidget {
  const DetailCommandeLivraison(
      {super.key, required this.tableRestaurantModel});
  final TableRestaurantModel tableRestaurantModel;

  @override
  State<DetailCommandeLivraison> createState() =>
      _DetailCommandeLivraisonState();
}
