...
class CourbeVenteGainDaySucc extends StatefulWidget {
  const CourbeVenteGainDaySucc(
  ...
  @override
  State<CourbeVenteGainDaySucc> createState() => _CourbeVenteGainDaySuccState();
}

class _CourbeVenteGainDaySuccState extends State<CourbeVenteGainDaySucc> {
