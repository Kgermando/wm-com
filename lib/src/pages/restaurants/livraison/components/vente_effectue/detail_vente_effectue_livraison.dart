...
class DetailVenteEffectueLivraison extends StatefulWidget {
  const DetailVenteEffectueLivraison(
      {super.key, required this.venteRestaurantModel});
  final VenteRestaurantModel venteRestaurantModel;

  @override
  State<DetailVenteEffectueLivraison> createState() =>
      _DetailVenteEffectueLivraisonState();
}

class _DetailVenteEffectueLivraisonState
    extends State<DetailVenteEffectueLivraison> {
