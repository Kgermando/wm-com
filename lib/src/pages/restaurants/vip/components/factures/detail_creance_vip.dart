...
import 'package:wm_com/src/pages/restaurants/vip/components/factures/cart/table_creance_vip_cart.dart';
import 'package:wm_com/src/pages/restaurants/vip/components/factures/pdf_a6/creance_vip_a6_pdf.dart';
...
class DetailCreanceVip extends StatefulWidget {
  const DetailCreanceVip({super.key, required this.creanceRestaurantModel});
  final CreanceRestaurantModel creanceRestaurantModel;

  @override
  State<DetailCreanceVip> createState() => _DetailCreanceVipState();
}

class _DetailCreanceVipState extends State<DetailCreanceVip> {
  final CreanceVipController controller = Get.find();
  final MonnaieStorage monnaieStorage = Get.put(MonnaieStorage());
  final CreanceVipPDFA6 creanceRestaurantPDFA6 = Get.put(CreanceVipPDFA6());
