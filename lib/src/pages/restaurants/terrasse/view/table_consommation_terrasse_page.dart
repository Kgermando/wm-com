...
class TableConsommationTerrassePage extends StatefulWidget {
  ...
  @override
  State<TableConsommationTerrassePage> createState() =>
      _TableConsommationTerrassePageState();
}

class _TableConsommationTerrassePageState
    extends State<TableConsommationTerrassePage> {
  final TableTerrasseController controller = Get.put(TableTerrasseController());
  final TerrasseController restaurantController = Get.put(TerrasseController());
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      return InkWell(
        onTap: () => Get.toNamed(TerrasseRoutes.tableConsommationTerrasseDetail,
            arguments: data),
        child: ClipRRect(
