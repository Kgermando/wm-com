...
class TableCommandeTerrassePage extends StatefulWidget {
  ...
  @override
  State<TableCommandeTerrassePage> createState() =>
      _TableCommandeTerrassePageState();
}
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      var restaurant = state!
          .where((element) =>
              element.table == data.table && element.statutCommande == 'false')
          .toList();
      Color? color;
      bool isBusy = false;
      ...
      return InkWell(
        onTap: () => Get.toNamed(TerrasseRoutes.tableCommandeTerrasseDetail,
            arguments: data),
        child: ClipRRect(
