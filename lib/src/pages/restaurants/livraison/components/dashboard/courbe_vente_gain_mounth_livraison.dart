...
class CourbeVenteGainMounthLivraison extends StatefulWidget {
  ...
  @override
  State<CourbeVenteGainMounthLivraison> createState() =>
      _CourbeVenteGainMounthLivraisonState();
}

class _CourbeVenteGainMounthLivraisonState
    extends State<CourbeVenteGainMounthLivraison> {
