...
class CourbeVenteGainDayLivraison extends StatefulWidget {
  ...
  @override
  State<CourbeVenteGainDayLivraison> createState() =>
      _CourbeVenteGainDayLivraisonState();
}

class _CourbeVenteGainDayLivraisonState
    extends State<CourbeVenteGainDayLivraison> {
