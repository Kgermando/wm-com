...
import 'package:wm_com/src/pages/restaurants/terrasse/components/consommation/pro_format_terrasse.dart';
import 'package:wm_com/src/pages/restaurants/terrasse/components/factures/pdf_a6/facture_terrasse_a6_pdf.dart';
...
class DetailConsommationTerrasse extends StatefulWidget {
  const DetailConsommationTerrasse(
      {super.key, required this.tableRestaurantModel});
  final TableRestaurantModel tableRestaurantModel;

  @override
  State<DetailConsommationTerrasse> createState() =>
      _DetailConsommationTerrasseState();
}

class _DetailConsommationTerrasseState
    extends State<DetailConsommationTerrasse> {
    ...
    return SpeedDial(
      ...
      speedDialChildren: <SpeedDialChild>[
        SpeedDialChild(
            ...
            label: 'Facture Pro',
            onPressed: () {
              ProFormatTerrassePDFA6().generatePdf(
